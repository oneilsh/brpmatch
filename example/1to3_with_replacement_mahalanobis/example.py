...
def main():
    ...
    n_controls = matched.select("match_id").distinct().count()
    print(f"  {highlight(str(n_pairs))} matched pairs across {value(str(n_treated))} treated ({n_controls} unique controls)")
