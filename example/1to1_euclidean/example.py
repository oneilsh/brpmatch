"""
Example: 1:1 Matching with Euclidean Distance

Demonstrates standard 1:1 propensity score matching using Euclidean distance.
...
def main():
    ...
    Each treated patient is matched to exactly one control patient.
    """
    print(section_header("1:1 Matching - Euclidean Distance", "="))
